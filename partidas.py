...
with cntr_tabs2:
    ...
    st.subheader("Gols e Presenças")
    st.caption("Ajuste os gols/assistências e jogadores presentes em cada partida")
    dfp["label"] = dfp.apply(
...
cntr_tabs3 = st.container(border=True)
with cntr_tabs3:

    tbcadastro, tbedit = st.tabs(['📋 Cadastrar','🔧 Editar/Excluir'])
